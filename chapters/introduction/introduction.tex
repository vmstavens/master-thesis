...
This project is composed of nine chapters, each listed below with an associated description. \medskip
...
\textbf{\chapref{ch:discussion}} The discussion chapter goes over the combined system and addresses problems, improvements, shortcomings and potential for future development.\medskip
